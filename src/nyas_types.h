...
typedef int NyasVtxLayout;   // enum NyasVtxLayout_
...
struct NyasShaderSrc {
    static constexpr inline char Header[] = NYAS_SHADER_HEADER(460 core);
...
struct NyPipelines {
    ...
    std::vector<NyResourceID> InternalIDs; // TODO(OpenGL): Move to NyasPipeline
